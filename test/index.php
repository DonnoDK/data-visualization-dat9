...
<head>
	...
	function populateArray(){
		...
		$.ajax({
		    ...
		    success: function (data) {
				$(data).find('a:contains(".bmp")').each(function () {
		           imageArr[0].push(this.href.replace(window.location.host, "").replace("http:///", "").replace("test/", "").replace("data-visualization-dat9", ""));
	       		});
		    }     
	  	});
		...
		$.ajax({
		    ...
		    success: function (data) {
				$(data).find('a:contains(".bmp")').each(function () {
		           imageArr[1].push(this.href.replace(window.location.host, "").replace("http:///", "").replace("test/", "").replace("data-visualization-dat9", ""));
	       		});
		    }     
	  	});
		$.ajax({
		    ...
		    success: function (data) {
				$(data).find('a:contains(".bmp")').each(function () {
		           imageArr[2].push(this.href.replace(window.location.host, "").replace("http:///", "").replace("test/", "").replace("data-visualization-dat9", ""));
	       		});
		    }     
	  	});
		$.ajax({
		    ...
		    success: function (data) {
				$(data).find('a:contains(".bmp")').each(function () {
		           imageArr[3].push(this.href.replace(window.location.host, "").replace("http:///", "").replace("test/", "").replace("data-visualization-dat9", ""));
	       		});
		    }     
	  	});
